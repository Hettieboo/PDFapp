...
def detect_and_correct_perspective(img_array):
    ...
    for contour in contours:
        ...
        if len(approx) == 4:
            ...
            return cv2.warpPerspective(img_array,M,(maxWidth,maxHeight))
    return img_array
...
# Processing button logic remains unchanged
# … [Keep your full file-processing code here exactly as before]
